...
private:
    ...
    bool handle_rescue_request(AP_Mission::Mission_Command &cmd) override { return true; }
    bool handle_dynamic_landing_request(AP_Mission::Mission_Command &cmd) override { return true; }
